...
const variantClasses: Record<Variant, string> = {
  ...
  "primary-lime": "bg-lime text-ink hover:bg-lime-deep",
...
const base =
  "inline-flex items-center justify-center rounded-full font-semibold transition-colors duration-200 whitespace-nowrap disabled:opacity-50 disabled:pointer-events-none";
